...
outputs=(
  "outputs/me1/me1_prefill_heavy_10rps_4tp2.csv"
  "outputs/me1/me1_decode_heavy_10rps_4tp2.csv"
  "outputs/me1/me1_balanced_10rps_4tp2.csv"
)
...
for i in "${!datasets[@]}"; do
  ...
  python -m serving \
    --cluster-config 'configs/cluster/me1_instance_4tp2.json' \
    --dtype bfloat16 \
    --dataset "${datasets[$i]}" \
    --output "${outputs[$i]}" \
    --num-reqs 60 \
